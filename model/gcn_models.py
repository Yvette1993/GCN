...
from utils import *
from loss import Cut_Balance_Loss, Cut_Balance_Loss_v2
...
class GCN_Block(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.conv2 = GCNConv(out_channels,
                             out_channels)
        self.conv3 = GCNConv(in_channels,
                             out_channels)
        # self.leakyrelu1 = torch.nn.LeakyReLU(negative_slope)
        # self.leakyrelu2 = torch.nn.LeakyReLU(negative_slope)
...
class DCGCNEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(self.depth):
            ...
            blocks += [
                GCN_Block(hop, in_channels_block, out_channels[i], heads, dropout,
...
class Netwrok(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.model_id = -1
        self.model_name = 'gcn_model'

        # 表示模块
        self.encoder = DCGCNEncoder(in_channels, out_channels[:-1], heads, dropout,
        ...
        self.loss = Cut_Balance_Loss_v2(N, nclass)
